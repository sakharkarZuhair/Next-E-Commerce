...
const Slug = ({ buyNow, addToCart, product, variants }) => {
  ...
  const checkServiceAbility = async () => {
    let pins = fetch(`${process.env.NEXT_PUBLIC_HOST}/api/pincode`);
          ...
          <div className="lg:w-4/5 mx-auto flex flex-wrap">
            ...
            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              ...
              <p className="leading-relaxed">
                ...
                Asperiores, iusto quod! Deserunt natus nobis sunt totam
                perspiciatis tempore, harum repellendus est cumque quis. Illum,
                ut repellendus! Ut perspiciatis ad reprehenderit eos obcaecati,
                quis asperiores culpa veniam, officiis officia, hic commodi
                itaque quisquam aliquam eveniet optio? Provident minus accusamus
                fugit rem?
              </p>
