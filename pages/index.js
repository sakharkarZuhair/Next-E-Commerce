...
export default function Home() {
    return ( <
        ...
        Choose from one of the most popular harry potter blogs.Subscribe to your favorite harry potter blogs
        for free. <
        /p> <
        /div> <
        ...
        p className = "leading-relaxed text-base mb-4" >
        Thoughts
        for the Serious Reader of Harry Potter <
        /p> <
        a className = "text-indigo-500 inline-flex items-center" >
        Learn More <
        svg fill = "none"
        ...
        /h2> <
        p className = "leading-relaxed text-base mb-4" >
        Join PotterCast in a continuing adventure through J.K.Rowling 's Wizarding World. For eleven years PotterCast has
        remained your trusted source
        for discussion, celebration, and interviews with creators and actors from the Harry Potter Universe. <
        /p> <
        a className = "text-indigo-500 inline-flex items-center" >
        Learn More <
        svg fill = "none"
